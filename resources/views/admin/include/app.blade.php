...
<head>
  ...
  <link href="{{ asset('vendor/admin/styles/main.css') }}" rel="stylesheet">
</head>
<body>
                ...
                <div class="widget-content-left">
                  <div class="btn-group">
                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                      <img width="42" class="rounded-circle" src="{{ asset('vendor/admin/images/avatars/1.jpg') }}" alt="">
            ...
            <ul class="vertical-nav-menu">
              ...
              <li class="@yield('components-active')">
                ...
                <ul class="@yield('components-collapse')">
                  <li>
                    <a href="{{ route('admin.category') }}" class="@yield('category-active')">
              ...
              <li class="app-sidebar__heading">Coming Soon</li>
            </ul>
          </div>
        </div>
      </div>    
              ...
              <div class="page-title-heading">
                ...
                <div>
                  ...
                  <div class="page-title-subheading">
                    Welcome to administrator control management system, you can modify anything here
                  </div>
                </div>
              </div>
          ...
          <div class="app-footer">
            <div class="app-footer__inner">
              <div class="app-footer-left">
                <ul class="nav">
                  <li class="nav-item">
                      <span>Copyright 2020 Noname. Allrights Reserved</span>
                  </li>
                </ul>
              </div>
...
<script type="text/javascript" src="{{ asset('vendor/admin/scripts/main.js') }}"></script>
</body>
</html>